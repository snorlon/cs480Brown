...
void sprite::init(config* simConfig)
{
    ...
    loc_position = glGetAttribLocation(simConfig->simShaderManager->activeProgram, "s_position");
    loc_texture = glGetAttribLocation(simConfig->simShaderManager->activeProgram, "s_tex");
}
